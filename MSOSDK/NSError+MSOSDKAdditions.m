...
+ (instancetype)mso_netserver_auto_mapping_not_created_error {
    return [NSError
            errorWithDomain:NSURLErrorDomain
            code:204
            userInfo:@{NSLocalizedDescriptionKey : @"Customer Mapping Error",
                       NSLocalizedFailureReasonErrorKey : @"No Auto-Mapping Created. The format was invalid"}];
}

+ (instancetype)mso_netserver_auto_mapping_update_error {
    return [NSError
            errorWithDomain:NSURLErrorDomain
            code:204
            userInfo:@{NSLocalizedDescriptionKey : @"Customer Mapping Error",
                       NSLocalizedFailureReasonErrorKey : @"No mapping was updated. The format was invalid"}];
}
